...
namespace Havit.NewProjectTemplate.WebAPI.Infrastructure.ConfigurationExtensions
{
    public static class CorsConfig
    {
        ...
        {
            services.Configure<Havit.NewProjectTemplate.WebAPI.Infrastructure.Cors.CorsOptions>(configuration.GetSection("AppSettings:Cors"));
            services.AddCors();
        }

        public static void UseCustomizedCors(this IApplicationBuilder app, IOptions<Havit.NewProjectTemplate.WebAPI.Infrastructure.Cors.CorsOptions> corsOptions)
        {
