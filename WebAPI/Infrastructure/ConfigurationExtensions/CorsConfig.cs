...
namespace Havit.VolejbalApp.WebAPI.Infrastructure.ConfigurationExtensions
{
    public static class CorsConfig
    {
        ...
        {
            services.Configure<Havit.VolejbalApp.WebAPI.Infrastructure.Cors.CorsOptions>(configuration.GetSection("AppSettings:Cors"));
            services.AddCors();
        }

        public static void UseCustomizedCors(this IApplicationBuilder app, IOptions<Havit.VolejbalApp.WebAPI.Infrastructure.Cors.CorsOptions> corsOptions)
        {
